...
\profilepic{../figures/f5}
\cvname{Oscar Ruiz\\ Cigarrillo} % Your name
\cvjobtitle{Doctor en Ciencias\\ Aplicadas} % Job title/career
...
\skills{{Bash/5},{Lua/3},{\LaTeX/6},{C/5},{C++/5},{Julia/5},{Fortran/6},{Python/6},{Linux/6}}
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{Desde 2017}{Doctor en Ciencias Aplicadas (Fot\'onica)}
...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{2015}{Beca CONACYT Maestr\'ia}
	\twentyitemshort{2017}{Beca CONACYT Doctorado}
...
\begin{twenty} % Environment for a list with descriptions
	...
	\twentyitem{2021-}{Introducci\'on a la F\'isica, F\'isica 1}
